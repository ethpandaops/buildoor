  ...
  return (
    <div className="mt-2">
      <div className="timeline-legend d-flex flex-wrap gap-2 small">
        ...
        <span className="legend-section ms-2">Legacy:</span>
        <span><span className="legend-dot bg-legacy-submitted"></span> Submitted</span>
        <span><span className="legend-dot bg-legacy-failed"></span> Failed</span>
      </div>
    </div>
  );
};
