...
const (
	...
	KeyBuilderAPIExecutionPayment    = "builder_api.execution_payment_gwei"
	KeyBuilderAPIExecutionPaymentPct = "builder_api.execution_payment_percent"
	KeyBuilderAPIIgnorePrefLimit     = "builder_api.ignore_preference_limit"
